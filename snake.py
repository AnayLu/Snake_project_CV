        ...
        if results.multi_hand_landmarks is not None:
            ...
            for i in range(len(snake2)):
                for j in range(i+1, len(snake2)):
                    ...
                    if not (abs(p1[0]-p3[0])<=10 or abs(p1[1]-p3[1])<=10 or abs(p1[0]-p4[0])<=10 or abs(p1[1]-p4[1])<=10 or abs(p2[0]-p3[0])<=10 or abs(p2[1]-p3[1])<=10 or abs(p2[0]-p4[0])<=10or abs(p2[1]-p4[1])<=10):
